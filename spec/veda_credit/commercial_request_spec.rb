...
describe VedaCredit::CommercialRequest do
  ...
  describe "with developer veda credit config file" do
     ...
     #    end
      ...
      describe "bureau reference" do 
        before do
          ...
          @request = VedaCredit::CommercialRequest.new(application_id: 1, access: @access_hash, service: @service_hash, bureau_reference: @bureau_reference, enquiry: @enquiry_hash)
        end
    ...
    #         @request = VedaCredit::CommercialRequest.new(application_id: 1, access: @access_hash, product: @product_hash, entity: @entity_hash, enquiry: @enquiry_hash) 
