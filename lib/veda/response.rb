module Veda
  class Response < ActiveRecord::Base
    self.table_name = "veda_responses"
    self.primary_key = :id
    ...
    def match
      match = Veda::Response.nested_hash_value(self.to_hash!, "primary_match")
      if match  
    ...
    def error
      connection_error = Veda::Response.nested_hash_value(self.to_hash!, "BCAerror")
      product_error = Veda::Response.nested_hash_value(self.to_hash!, "error")
